 ...
 */
class ExportableIVMyFunction : public ExportableIVObject
{
    Q_GADGET
...
public:
    explicit ExportableIVMyFunction(const ivm::IVFunctionType *function = nullptr);
...
Q_DECLARE_METATYPE(ive::ExportableIVMyFunction)
Q_DECLARE_TYPEINFO(ive::ExportableIVMyFunction, Q_MOVABLE_TYPE);
